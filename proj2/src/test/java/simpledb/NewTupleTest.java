...
public class NewTupleTest extends SimpleDbTestBase {
    ...
    /**
     * Unit simpledb.test for simpledb.Tuple.getField() and simpledb.Tuple.setField()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.Tuple.getTupleDesc()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.Tuple.getRecordId() and simpledb.Tuple.setRecordId()
     */
	...
	try {
    	...
    	throw new UnsupportedOperationException("modifyRecordId() simpledb.test failed due to " +
    			"simpledb.RecordId.equals() not being implemented.  This is not required for Lab 1, " +
    			"but should pass when you do implement the simpledb.RecordId class.");
	}
    }
    ...
    /**
     * Helper class for iterator simpledb.test.
     */
