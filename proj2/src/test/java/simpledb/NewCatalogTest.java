...
public class NewCatalogTest extends SimpleDbTestBase {
    private static String name = "simpledb.test";
    ...
    /**
     * Unit simpledb.test for simpledb.Catalog.getTupleDesc()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.Catalog.getTableId()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.Catalog.getDbFile()
     */
    @Test public void getDbFile() throws Exception {
        DbFile f = Database.getCatalog().getDbFile(-1);

        // NOTE(ghuo): we try not to dig too deeply into the simpledb.DbFile API here; we
    ...
    @Test public void new_getTupleDescTest() throws Exception {
        try {
            ...
            Assert.fail("Should not find simpledb.TupleDesc with id " + 100);
        } catch (NoSuchElementException e) {}
    }
    ...
    @Test public void new_getDbFileTest() throws Exception {
        try {
            ...
            Assert.fail("Should not find simpledb.DbFile with id " + 100);
        } catch (NoSuchElementException e) {}
    }
