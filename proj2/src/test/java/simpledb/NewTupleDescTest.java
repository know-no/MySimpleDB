...
public class NewTupleDescTest extends SimpleDbTestBase {
    ...
    /**
     * Unit simpledb.test for simpledb.TupleDesc.combine()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.TupleDesc.getType()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.TupleDesc.nameToId()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.TupleDesc.getSize()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.TupleDesc.numFields()
     */
    ...
    @Test public void new_fieldNameToIndexTest() {
        ...
        assertEquals(0, nullTD.fieldNameToIndex(null)); // simpledb.Field name can be set to null manually.
    }
