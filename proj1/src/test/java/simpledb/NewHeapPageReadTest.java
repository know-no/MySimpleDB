...
public class NewHeapPageReadTest extends SimpleDbTestBase {
    ...
    static {
        ...
        // Convert it to a simpledb.HeapFile and read in the bytes
        try {
    ...
    /**
     * Unit simpledb.test for simpledb.HeapPage.getId()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.HeapPage.iterator()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.HeapPage.getNumEmptySlots()
     */
    ...
    /**
     * Unit simpledb.test for simpledb.HeapPage.isSlotUsed()
     */
