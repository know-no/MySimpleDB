...
public class TestUtil {
    /**
     * @return an simpledb.IntField with value n
     */
    ...
    /**
     * @return a simpledb.DbIterator over a list of tuples constructed over the data
    ...
    /**
     * Verifies that the simpledb.DbIterator has been exhausted of all elements.
     */
    ...
    /**
     * Stub simpledb.DbFile class for unit testing.
     */
    ...
    /**
     * Mock simpledb.SeqScan class for unit testing.
     */
    public static class MockScan implements DbIterator {
        private int cur, low, high, width;

        /**
         * Creates a fake simpledb.SeqScan that returns tuples sequentially with 'width'
